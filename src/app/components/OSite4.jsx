...
const OSite4 = () => {
  const cardsData = [
    { title: 'Parte do quadro geral', content: '5. Montando a celebração de final de ano.', icon: '🌐' },
    { title: 'Capítulos do livro do estudante', content: '9. É hora da festa! 10. / Tudo o que aprendemos.' , icon: '📚'},
    { title: 'Atividades do projeto', content: 'V - Avaliação. / VI - Conclusão e Culminância.' , icon: '📋'},
    { title: 'Matemática e educação financeira', content: 'Leitura e interpretação de tabelas e gráficos.' , icon: '🧮'},
    { title: 'Recursos didáticos', content: 'Jogo de perguntas e respostas. / Redes sociais.' , icon: '🎮'},
  ];
